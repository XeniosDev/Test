...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: qeH1lNcEe-Jw8B/css
import Searchsvg2Icon from "./icons/PlasmicIcon__Searchsvg2"; // plasmic-import: SsHHWD-Hq9CL7T/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: TgELJqb0-PjcfB/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Searchsvg2Icon
                className={classNames(projectcss.all, sty.svg__d96D5)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___4UGrh)}
                role={"img"}
              />
            ),
