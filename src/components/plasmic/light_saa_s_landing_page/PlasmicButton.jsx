...
import sty from "./PlasmicButton.module.css"; // plasmic-import: xoknyxKmeB3HA2/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__iAtqI)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__ry9Zc)}
                role={"img"}
              />
            ),
